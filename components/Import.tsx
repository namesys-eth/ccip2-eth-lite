...
const ResolverModal: React.FC<ModalProps> = ({
  show,
  onClose,
  children,
  handleModalData,
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setHelpModal(true),
                    setHelp(
                      '<span><span style="color: cyan">Import records</span> from ENS Resolver. Please enter <span style="color: cyan">Source Resolver Address</span></span>'
                    );
                }}
