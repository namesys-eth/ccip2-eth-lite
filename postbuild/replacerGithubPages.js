...
const optionsCSS = {
  ...
  to: ['https://namesys-eth.github.io/ccip2-eth-lite/_next/', 'ccip2-eth-lite/shadow.svg'],
};
const optionsJS = {
  files: ['./out/_next/static/chunks/*.js', './out/_next/static/chunks/pages/*.js'],
  from: [/_next\//g, /ens-red.png/g, /href=\"\//g],
  to: ['ccip2-eth-lite/_next/', 'ccip2-eth-lite/ens-red.png', 'href="/ccip2-eth-lite/'],
};
const optionsHTML = {
  files: './out/*.html',
  from: [/_next\/static/g, /ens-red.png/g],
  to: ['ccip2-eth-lite/_next/static', 'ccip2-eth-lite/ens-red.png'],
};
(async function () {
  try {
